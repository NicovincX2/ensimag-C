    ...
    for cat in skills:
        ...
        for skill in skills[cat]:
            ...
            for name, exo in skills[cat][skill].items():
                ...
                liens[lvl] += """<a href={}><img src=\"https://img.shields.io/static/v1.svg?label={}&message={}&color={}\" /></a> """.format(
                    os.path.join("exercices", name),
                    name,
                    exo['maitrise'],
                    lvl
                )
            html_table.td(liens['brightgreen'] + liens['yellow'] + liens['red'], escape=False)
